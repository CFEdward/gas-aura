...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	*/
	...
	GameplayTags.Abilities_Passive_HitReact = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Passive.HitReact"),
	...
	GameplayTags.Abilities_Fire_Bolt = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Fire.Bolt"),
		FString("Fire Bolt Ability Tag")
	);

	GameplayTags.Abilities_Fire_Blast = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Abilities.Fire.Blast"),
	...
	*/
	...
	GameplayTags.Cooldown_Fire_Bolt = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Cooldown.Fire.Bolt"),
