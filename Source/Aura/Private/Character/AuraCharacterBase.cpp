...
float AAuraCharacterBase::TakeDamage(float Damage, struct FDamageEvent const& DamageEvent, class AController* EventInstigator, AActor* DamageCauser)
{
...
FOnDamage& AAuraCharacterBase::GetOnDamage()
{
	return OnDamage;
}
